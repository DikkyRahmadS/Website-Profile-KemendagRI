		...
		<nav class="main-header navbar navbar-expand navbar-dark navbar-dark">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item mr-3">
					<a class=" btn btn-md btn-info" href="#" role="button">
						<i class="fas fa-user-alt" style="font-size: x-large;">
							<?php echo $namauser ?></i>
					</a>
				</li>

				<li class="nav-item">
					<button class=" btn btn-md btn-warning logout ">
						<i class="fas fa-sign-out-alt nav-icon" style="font-size: x-large;"> Logout</i>
					</button>
				</li>
