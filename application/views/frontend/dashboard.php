<section>
    <div class="w-100 pt-120 pb-100 position-relative">
        <img class="img-fluid sec-top-mckp position-absolute" src="assets/frontend/images/sec-top-mckp2.png" alt="Sec Top Mockup 2">
        <div class="container">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="product-name">
                                        <h5 class="mb-0"><a style="color: red;" href="<?php echo $data->pengumuman_slug  ?>" title=""><i class="fas fa-volume-up"></i> <?php echo $data->pengumuman_judul  ?></a></h5>

                                    </td>
                                    <td class="product-price"><span><?php echo $data->pengumuman_waktu  ?></span></td>

                                    <td class="product-total-price"><span><a class="btn bg-color2" href="<?php echo base_url('pengumuman/') . $data->pengumuman_slug; ?>"><i class="fas fa-search-plus"></i> Lihat</a></span></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table><!-- Cart Table -->
            ...
            <div class="view-more mt-50 d-inline-block text-center w-100">
                <a class="thm-btn bg-color1" href="<?php echo base_url('pengumuman/list') ?>" title="">Daftar Pengumuman<span></span><span></span><span></span><span></span></a>
            </div>
        </div>
    </div>
</section>
...
<section>
    <div class="w-100 pt-100 pb-100 position-relative">
        ...
        <div class="container">
            <div class="sec-title text-center w-100">
                <div class="sec-title-inner d-inline-block">
                    <h2 class="mb-0">Kegiatan Terbaru</h2>
                ...
                ?>
                    <div class="post-box2 position-relative d-flex flex-wrap align-items-center w-100">
                        <div class="post-img2 overflow-hidden position-absolute">
                            <a href="<?php echo base_url('kegiatan/') . $data->kegiatan_slug  ?>" title=""><img class="img-fluid " src="<?php echo base_url() ?>uploads/kegiatan/<?php echo $data->kegiatan_foto ?>" style="width: 697px; height: 460px;" alt="Blog Image 1"></a>
                        </div>
                        ...
                        <div class="post-info2">
                            ...
                            <ul class="post-meta2 d-inline-flex flex-wrap align-items-center mb-0 list-unstyled">
                                <li class="thm-clr"><?php
                                                    $now = time();
                                                    echo timespan(strtotime($data->kegiatan_waktu), $now) . ' ago'; ?></li>
                                <li class="thm-clr"><img class="img-fluid rounded-circle" src="assets/frontend/images/resources/post-author-thumb1-1.jpg" alt="Post Author Thumb 1">BY: <a href="javascript:void(0);" title=""><?php echo $data->user_nama; ?></a></li>
                            </ul>
                            <h3 class="mb-0"><a href="<?php echo base_url('kegiatan/') . $data->kegiatan_slug  ?>" title=""><?php echo $data->kegiatan_judul; ?></a></h3>
                            <p class="mb-0"><?php echo substr($data->kegiatan_isi, 0, 200); ?></p>
                            <a class="thm-btn thm-bg" href="<?php echo base_url('kegiatan/') . $data->kegiatan_slug  ?>" title="">Continue
            ...
            <div class="view-more mt-50 d-inline-block text-center w-100">
                <a class="thm-btn bg-color1" href="<?php echo base_url('kegiatan/list') ?>" title="">Daftar Kegiatan<span></span><span></span><span></span><span></span></a>
            </div><!-- View More -->
        </div>
    </div>
</section>
